...
const featureDescriptionOverrides: Record<string, string> = {
  'Profesyonel Ekip':
    'Saha kaptanları, marangoz ve paketleme uzmanlarından oluşan ekibimiz her taşınmayı operasyon planı olarak kurgular; sorumlu kişiler taşıma boyunca yanınızdadır.',
  'Güvenli Taşıma':
    'RFID etiketleme, çift kat ambalaj ve darbe sensörlü kasalarla her parçayı kayıt altına alır, taşıma zincirini raporlarız.',
  'Uygun Fiyat':
    'Şeffaf maliyet tabloları, sabit kur koruması ve paket bazlı ücretlendirme sayesinde bütçenize uygun premium hizmet sunarız.',
  'Sigortalı Hizmet':
    'Paketleme anından montaja kadar tüm süreç sigortalıdır; poliçe detaylarını ve teminat limitlerini taşıma öncesi onayınıza sunarız.',
  '7/24 Destek':
    'Operasyon masamız taşınma günü boyunca canlı mesaj ve telefonla size eşlik eder, anlık güncellemeleri paylaşır.',
  'Zamanında Teslimat':
    'Rota optimizasyonu, zaman penceresi planı ve GPS takip ile belirlenen saat aralığında teslimat garantisi veriyoruz.',
}
;

...
export default function SettingsForm({ initialSettings }: SettingsFormProps) {
  ...
  const settingsFields = [
    ...
    { key: 'address_locality', label: 'Adres İlçe', type: 'text' },
    { key: 'address_region', label: 'Adres Şehir/Bölge', type: 'text' },
    { key: 'address_postal_code', label: 'Posta Kodu', type: 'text' },
    { key: 'address_country', label: 'Ülke Kodu (örn: TR)', type: 'text' },
